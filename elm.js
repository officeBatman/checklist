...
var $author$project$Main$Model = F3(
	function (tasks, next_task_id, next_task_text) {
		return {next_task_id: next_task_id, next_task_text: next_task_text, tasks: tasks};
	});
var $author$project$Main$Task = F2(
	function (text, checked) {
		return {checked: checked, text: text};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$decodeTask = A3(
...
var $author$project$Main$decode = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Model,
	A2(
		$elm$json$Json$Decode$field,
		'tasks',
		A2($elm_community$json_extra$Json$Decode$Extra$dict2, $elm$json$Json$Decode$int, $author$project$Main$decodeTask)),
	A2($elm$json$Json$Decode$field, 'next_task_id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'next_task_text', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$core$Debug$log = _Debug_log;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (encoded) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decode, encoded);
	if (_v0.$ === 'Ok') {
		var model = _v0.a;
		...
		return function (_v1) {
			return _Utils_Tuple2(
				{next_task_id: 0, next_task_text: '', tasks: $elm$core$Dict$empty},
...
var $author$project$Main$encodeTask = function (_v0) {
	var text = _v0.text;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'tasks',
				A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $author$project$Main$encodeTask, model.tasks)),
				_Utils_Tuple2(
				'next_task_id',
				$elm$json$Json$Encode$int(model.next_task_id)),
				_Utils_Tuple2(
				'next_task_text',
				$elm$json$Json$Encode$string(model.next_task_text))
			]));
};
var $author$project$Ports$setStorage = _Platform_outgoingPort('setStorage', $elm$core$Basics$identity);
var $author$project$Main$modelAndSave = function (model) {
	return _Utils_Tuple2(
		model,
		...
		switch (msg.$) {
			case 'AddTask':
				...
				if (task.text === '') {
					...
					var tasks = A3($elm$core$Dict$insert, model.next_task_id, task, model.tasks);
					var next_task_id = model.next_task_id - 1;
					return $author$project$Main$modelAndSave(
						_Utils_update(
							model,
							{next_task_id: next_task_id, next_task_text: '', tasks: tasks}));
				}
			case 'TypedNextTask':
				var task = msg.a;
				return $author$project$Main$modelAndSave(
			...
			case 'CheckTask':
				var index = msg.a;
				var checked = msg.b;
				var _v1 = A2($elm$core$Dict$get, index, model.tasks);
				if (_v1.$ === 'Just') {
					var task = _v1.a;
					return $author$project$Main$modelAndSave(
						_Utils_update(
			...
			default:
				...
				return $author$project$Main$modelAndSave(
					_Utils_update(
						model,
						{
							tasks: A2($elm$core$Dict$remove, index, model.tasks)
						}));
		}
	});
...
var $author$project$Main$colors = {
	dark: A3($mdgriffith$elm_ui$Element$rgb255, 25, 28, 26),
	light: A3($mdgriffith$elm_ui$Element$rgb255, 226, 233, 225),
	saturated: A3($mdgriffith$elm_ui$Element$rgb255, 48, 164, 60)
};
...
var $author$project$Main$TypedNextTask = function (a) {
	return {$: 'TypedNextTask', a: a};
};
...
var $author$project$Main$viewAddTask = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
						...
						[
							...
							$elm_community$html_extra$Html$Events$Extra$onEnter(
								$author$project$Main$AddTask(
									{checked: false, text: model.next_task_text})))
						]),
					{
						label: A2(
							$mdgriffith$elm_ui$Element$Input$labelLeft,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('New Task')),
						onChange: $author$project$Main$TypedNextTask,
...
var $author$project$Main$CheckTask = F2(
	function (a, b) {
		return {$: 'CheckTask', a: a, b: b};
	});
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						...
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('Done'),
						onChange: $author$project$Main$CheckTask(index)
					}),
					...
					_List_Nil,
					{
						...
						onPress: $elm$core$Maybe$Just(
							$author$project$Main$RemoveTask(index))
					})
				]));
	});
	...
	return A2(
		...
		A2(
			...
			$elm$core$Dict$toList(
				A2($elm$core$Dict$map, $author$project$Main$viewTask, tasks))));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$padding(20),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colors.dark)
			]),
		_List_fromArray(
			[
				$author$project$Main$viewAddTask(model),
